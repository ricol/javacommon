 ...
 *
 * Remarks ------- - don't use AffineTransform for rescaling since it inverts images and strings - careful using setFont in inner loop within an animation - it
 * can cause flicker
 *
...
/**
 * <i>Standard draw</i>. Our class StdDraw provides a basic capability for creating drawings with your programs. It uses a simple graphics model that allows you
 * to create drawings consisting of points, lines, and curves in a window on your computer and to save the drawings to a file.
 * <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener
{
    ...
    ************************************************************************
    ...
    /**
     * Set the pen color to the given color. The available pen colors are BLACK, BLUE, CYAN, DARK_GRAY, GRAY, GREEN, LIGHT_GRAY, MAGENTA, ORANGE, PINK, RED,
     * WHITE, and YELLOW.
     *
    ...
    ************************************************************************
    ...
    /**
     * Display on screen and pause for t milliseconds. Calling this method means that the screen will NOT be redrawn after each line(), circle(), or square().
     * This is useful when there are many methods to call to draw a complete picture.
     *
